...
<div class="container-fluid">
    <div class="row">
      	<div class="col-lg-10 col-lg-offset-1">
	      	<h2 class="western spaceClass titreService" style="text-align: justify; color: #FF4500">Offres de recrutement</h2>
	      	<p style="text-align: justify">Vous voulez travailler avec une équipe accueillante, dans un cadre reposant et auprès de personnes qualifiées ? Tentez de postuler pour l'une de nos offres d'emploi !</p> <br /> 
	      	<p style="text-align: justify">Pour postuler à nos offres d'emploi, envoyer nous un <a href="contact.php">message</a> avec l'intitulé du poste, votre CV et lettre de motivation. Nous vous recontacterons au plus vite.</p><br />
	      	<p class="western" style="text-align: justify; border-width: 2px; border-style: dotted; padding-left: 5px; padding-right: 5px;"><span style="font-weight: 600">Hôtesse d'accueil H/F</span><br /> 
	      	Type d'emploi : CDD d'un an <br />
	     	30h/semaine (possibilité d'un contrat en 35h/semaine) <br />
	      	...
	      	Vous menez en parallèle des tâches notariales de type copie d’actes ou d’attestations, affranchissement du courrier…
			Vos tâches seront évolutives en fonction de vos capacités d’apprentissage. <br />
			...
			Rémunération sur 13 mois négociable fonction de votre niveau d’expérience.
			</p> <br /> <br />
			<p class="western" style="text-align: justify; border-width: 2px; border-style: dotted; padding-left: 5px; padding-right: 5px;"><span style="font-weight: 600">Coach sportif H/F</span><br /> 
			Type d'emploi : CDI <br />
			35h/semaine <br />
			...
			<p style="text-align: justify">C'est tout pour le moment, n'hésitez pas à consulter cette page régulièrement car nos offres d'emplois sont renouvellées très fréquemment. </p>
	    </div>
	</div>
</div>
