                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Membres</a>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="#register_form" class="popup-with-zoom-anim"   
                            <i class="fa fa-user-plus"></i>Registration</a></li>
